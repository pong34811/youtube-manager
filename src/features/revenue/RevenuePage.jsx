  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <KpiCard label={t("overview.revenue")} value={`$${formatNumber(Math.round(estimatedRevenue))}`} trend={15} />
        <KpiCard label={t("revenue.rpm")} value="$2.00" trend={2} />
        <KpiCard label={t("revenue.cpm")} value="$4.00" trend={-1} />
      </div>
